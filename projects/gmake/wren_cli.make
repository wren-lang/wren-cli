...
OBJECTS := \
	...
	$(OBJDIR)/linux-core.o \
	$(OBJDIR)/linux-inotify.o \
	$(OBJDIR)/linux-syscalls.o \
	$(OBJDIR)/loop-watcher.o \
	$(OBJDIR)/loop.o \
	$(OBJDIR)/pipe.o \
	$(OBJDIR)/poll.o \
	$(OBJDIR)/process.o \
	$(OBJDIR)/procfs-exepath.o \
	$(OBJDIR)/proctitle.o \
	$(OBJDIR)/random-devurandom.o \
	$(OBJDIR)/random-getrandom.o \
	$(OBJDIR)/random-sysctl-linux.o \
	$(OBJDIR)/signal.o \
	$(OBJDIR)/stream.o \
	$(OBJDIR)/sysinfo-loadavg.o \
	$(OBJDIR)/tcp.o \
	$(OBJDIR)/thread.o \
	$(OBJDIR)/tty.o \
	$(OBJDIR)/udp.o \
	$(OBJDIR)/uv-common.o \
	$(OBJDIR)/uv-data-getter-setters.o \
	$(OBJDIR)/version.o \
