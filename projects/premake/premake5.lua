workspace "wren-cli"
  ...
  newoption {
    trigger = "bsd",
    value = "<BSD variant>",
    description = "Build settings specific to BSD variant",
    allowed = {
      { "free", "FreeBSD" },
      { "net", "NetBSD" }
    }
  ...
  filter { "system:bsd", "options:bsd=free" }
    location ("../gmake.freebsd")
...
-- libuv dependency
  ...
  filter "options:bsd=free"
    links { "dl" }
    files { "../../deps/libuv/src/unix/freebsd.c" }
        
  filter "options:bsd=net"
    links { "kvm" }
    files { "../../deps/libuv/src/unix/netbsd.c" }